...
fn render() !void {
    var shader = try runner.gfx.Shader.initFromFile(std.testing.allocator, "examples/assets/shaders/1_4_textures.vert", "examples/assets/shaders/1_4_textures.frag");
    ...
    // textures
    var tex1 = runner.gfx.Texture.initFromFile(std.testing.allocator, "examples/assets/textures/container.png", .nearest) catch unreachable;
    var tex2 = runner.gfx.Texture.initFromFile(std.testing.allocator, "examples/assets/textures/awesomeface.png", .nearest) catch unreachable;
